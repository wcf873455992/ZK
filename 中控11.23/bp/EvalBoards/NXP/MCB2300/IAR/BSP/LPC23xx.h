...
//#define  VICIntSelect       (*(CPU_INT32U *)(VIC_BASE_ADDR    + 0x000C))
//#define  VICIntEnable       (*(CPU_INT32U *)(VIC_BASE_ADDR    + 0x0010))
#define VICVectPri(n)    (*(volatile unsigned long *)(VIC_BASE_ADDR + 0x200+(4*n)))
#define  VICVectAddrs(n)     (*(CPU_INT32U *)(VIC_BASE_ADDR    + 0x0100 + (4 * (n))))
#define  VICVectCntl(n)     (*(CPU_INT32U *)(VIC_BASE_ADDR    + 0x0200 + (4 * (n))))
//向量中断通道
#define VIC_CHANLE_WD			0
#define VIC_CHANLE_ARMCORE0 	2
#define VIC_CHANLE_ARMCORE1	3
#define VIC_CHANLE_TIME0		4
#define VIC_CHANLE_TIME1		5
#define VIC_CHANLE_UART0		6
#define VIC_CHANLE_UART1		7
#define VIC_CHANLE_PWM1		8
#define VIC_CHANLE_I2C0			9
#define VIC_CHANLE_SPI_SSP0	10
#define VIC_CHANLE_SSP1			11
#define VIC_CHANLE_PLL			12
#define VIC_CHANLE_RTC			13
#define VIC_CHANLE_EINT0		14
#define VIC_CHANLE_EINT1		15
#define VIC_CHANLE_EINT2		16
#define VIC_CHANLE_EINT3		17
#define VIC_CHANLE_ADC			18
#define VIC_CHANLE_I2C1			19
#define VIC_CHANLE_BOD			20
#define VIC_CHANLE_ETHEMET		21
#define VIC_CHANLE_USB			22
#define VIC_CHANLE_CAN1_2		23
#define VIC_CHANLE_SD_MMC		24
#define VIC_CHANLE_GPDMA		25
#define VIC_CHANLE_TIME2		26
#define VIC_CHANLE_TIME3		27
#define VIC_CHANLE_UART2		28
#define VIC_CHANLE_UART3		29
#define VIC_CHANLE_I2C2			30
#define VIC_CHANLE_I2S			31
