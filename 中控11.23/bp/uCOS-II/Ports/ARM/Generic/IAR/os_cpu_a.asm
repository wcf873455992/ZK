...
;********************************************************************************************************
    ...
    PUBLIC  OS_CPU_SR_INT_Dis
    PUBLIC  OS_CPU_SR_INT_En
    PUBLIC  OS_CPU_SR_IRQ_Dis
    PUBLIC  OS_CPU_SR_IRQ_En
    PUBLIC  OS_CPU_SR_FIQ_Dis
    PUBLIC  OS_CPU_SR_FIQ_En
...
OS_CPU_SR_INT_En
	...
	BIC 	R12, R12, #I_BIT      		; clear the interrupt disable bit
        BIC 	R12, R12, #F_BIT      		; clear the interrupt disable bit
	MSR 	CPSR_c, R12           
	BX		LR   
...
OS_CPU_SR_FIQ_Dis
    MRS     R12, CPSR           		; get current CPU mode
    ORR     R12, R12, #F_BIT    		; set the interrupt disable mode bit
    MSR     CPSR_c, R12         
    BX		LR                  
